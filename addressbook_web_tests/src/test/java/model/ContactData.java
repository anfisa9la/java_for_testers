...
public record ContactData(String id, String firstName, String middleName, String lastName, String photo) {
    ...
    public ContactData withId(String id) {
        return new ContactData(id, this.firstName, this.middleName, lastName, this.photo);
    }

    public ContactData withPhoto(String photo) {
        return new ContactData(id, this.firstName, this.middleName, this.lastName, photo);
    }
}