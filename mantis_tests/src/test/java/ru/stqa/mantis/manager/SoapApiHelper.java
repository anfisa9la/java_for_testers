...
public class SoapApiHelper extends HelperBase {
    ...
    public SoapApiHelper(ApplicationManager manager) throws MalformedURLException, ServiceException {
        super(manager);
    ...
    public void createIssue(IssueData issueData) {
        try {
            ...
            mantis.mc_issue_add(manager.property("web.user"),
                    manager.property("web.password"),
                    issue);
